 ...
 return(
   ...
   {/* ....... Expirence............ */}
        ...
        <EditIcon
            ...
            <div style={{padding:"15px"}}>  
                <div>
                    <Typography variant="h5">Expirence</Typography>
                    <Divider inset="none" />
                </div>
        ...
        />
         ...
         <div style={{padding:"15px"}}> 
            ...
            <div >
                ...
                <Typography sx={{marginTop:"20px",padding:'10px'}}>
                      RV College of Arts and Science. (PG)<br/>
                      Msc Computer Science<br/>
                      2014-2016
                </Typography>

                <Typography sx={{padding:'10px'}}>
                      RV College of Arts and Science. (UG)<br/>
                      Bsc Computer Science<br/>
                      2011-2014
                </Typography>

                <Typography sx={{padding:'10px'}}>
                   SRSI Matric Higher Secondary School. (HSC)<br/>
                    2009-2011
                </Typography>

                <Typography sx={{padding:'10px'}}>
                   SRSI Matric Higher Secondary School. (SSLC)<br/>
                    2008-2009
                </Typography>
             </div>
         </div>
